...
signatures_jsonfile = os.path.dirname(os.path.abspath(__file__)) + '/data/signatures/signatures.json'
with open(signatures_jsonfile, "r") as json_file:
    cached_signatures = json.load(json_file)
